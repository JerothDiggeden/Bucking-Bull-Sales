...
def update_ddn_clerks(clerks):
    ...
    counter = 0
    for c in clerks:
        one = f"txt_box_clerks{counter + 1}.insert('0.0', clerks[{counter}])"
        counter = counter + 1
        exec(one)
